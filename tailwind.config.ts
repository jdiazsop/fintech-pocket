...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "card": "0 1px 2px hsl(220 40% 20% / 0.04), 0 1px 3px hsl(220 40% 20% / 0.03)",
        "elevated": "0 4px 16px -4px hsl(220 40% 20% / 0.08), 0 2px 6px -2px hsl(220 40% 20% / 0.05)",
        "glow": "0 4px 14px -4px hsl(221 83% 53% / 0.18)",
        "glow-lg": "0 8px 24px -6px hsl(221 83% 53% / 0.22)",
      },
    },
  },
